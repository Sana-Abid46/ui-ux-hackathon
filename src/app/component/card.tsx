...
const Card = ({ frame, src, alt, heading, Rating, price, disprice, redbtn }: { frame?: any, src: any, alt: string, heading: string, Rating: string, price: string, disprice?: string, redbtn?: string}) => {
  return (
    <main>
